...
downstream = fread(paste0("../results/BEDS/", CHR, "_transcripts_upTTS_FANTOM5.bed"), header = F)
...
write.table(downstream_2, file = paste0("../results/BEDS/", CHR, "_transcripts_upstream_TTS_nontranscribed_FANTOM5.bed"), quote = F, row.names = F, col.names = F, sep = "\t", append = F)
